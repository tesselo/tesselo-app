...
import aggregationArea from '@/services/state/aggregation-area/store'
...
import aggregationAreaState from '@/services/state/aggregation-area/store/aggregation-area.state'
