    ...
    <el-col
      ...
      <el-row
        ...
        <line-chart
          ...
          :labels="reportArea ? chartMonths : labels"
          :datasets="reportArea ? chartData : datasets"
...
export default {
  ...
  data () {
    return {
      ...
      chartColors: ['rgba(255, 99, 132, 0.9)', 'rgba(54, 162, 235, 0.9)','rgba(75, 192, 192, 0.9)','rgba(255, 225, 86, 0.9)', 'rgba(255, 159, 64, 0.9)','rgba(153, 102, 255, 0.9)','rgba(201, 203, 207, 0.9)'],
      ...
      this.chartData = this.reportChartYears.map((year, idx) => {
        ...
        return {
          ...
          data: this.chartMonths.map((month) => {
                  ...
                  const area = that.reportChartData.find(entry => entry.month === month && entry.year === year)
